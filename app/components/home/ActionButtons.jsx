...
export default function ActionButtons() {
  return (
    ...
    >
      <Link
        href={"/find-mosque"}
        className="flex-1 flex justify-center items-center cursor-pointer bg-white text-[#006E3E] font-semibold p-3 rounded-xl shadow-lg hover:bg-slate-50 transition-colors text-[20px]"
      >
        Find Mosque Near Me
      </Link>
